...
public class BrokenLinkImageDemo {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get("https://demoqa.com/");
		 ...
		 driver.manage().window().maximize();
			...
			clk(ele,driver);
			Thread.sleep(4000);
			WebElement ele1 = driver.findElement(By.xpath("//div[@class='element-list collapse show']//li[@id='item-6']"));
			clk1(ele1,driver);
			Thread.sleep(4000);
			
			driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[2]/div[2]/div[2]/a[1]")).click();
